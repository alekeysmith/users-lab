...
// In-memory data
let users = [
    new User(1, 'Joan Alexander Julian', 'joanalexander', 'joanalexander@gmail.com', 'password123', new Date(), 'joan.jpg', 'admin'),
    new User(2, 'Ingenieria de Sistemas', 'sistemas', 'sistemas@gmail.com', 'password123', new Date(), 'sistemas.jpg', 'user'),
